...
const data = [
  ...
  },
  {
    ...
    body:
      "Tech Teahouse is building a more diverse and inclusive tech community in Toronto by increasing access to tech-focused events, providing a forum to foster meaningful connections, and hosting free personal development workshops for underrepresented groups. Some of our initiatives include:",
    icons: [
      { initiatives: "Tech Teahouse workshop series" },
  ...
  },
  {
    ...
    body:
      "Our members are reflective of the diverse backgrounds and experiences that comprise of the communities where we work and live. Our vision is to build and grow an inclusive Toronto tech community where members are given the opportunity for professional development.",
    icons: [
      {
        src: personImg,
  ...
  },
  {
    ...
    body:
      "We believe that investing in our local Toronto Tech community fosters innovation and we want to make professional development opportunities accessible. Therefore all contributions made will go directly to the following goals:",
    icons: [
      {
        src: youthImg,
        headerTwo: "Youth Workshops",
        body:
          "Host a tech skills workshop for youth of underrperesented groups.",
      },
      {
        src: careerImg,
        headerTwo: "Career Development",
        body:
          "Our professional workshops offers attendees insight and knowledge on topics to that will help them advance their careers.",
      },
      {
        src: communityBuilding,
        headerTwo: "Community Building",
        body:
          "We aim to build our community and double the number of Tech Teahouse active members by 2020.",
      },
    ],
  },
  {
    ...
    icons: [
      {
        ...
        link: "https://www.linkedin.com/company/techteahouse/",
      },
      {
        src: twitter,
        headerTwo: "Twitter",
        body:
          "Follow us @TechTeahouse and share your opinion with #TechTeahouse",
        link: "https://www.twitter.com/TechTeahouse",
      },
      {
        src: instagram,
        headerTwo: "Instagram",
        body: "Follow and tag us @TechTeahouse",
        link: "https://www.instagram.com/techteahouse/",
      },
    ],
  },
]
